...
export { collectResourceTiming, observeResourceTiming } from './resourceTiming.js'
export type { ResourceTimingOptions } from './resourceTiming.js'
export { getSelector } from './lib/getSelector.js'
